...
import { ManifiestosTable, ModalAsignar, ViewTabs } from "../../components/bpt/supervisor";
import { useGetUsersForManifiestos, useManifiestosSocket } from "../../hooks/bpt/hooks";
  ...
  return (
    <>
      ...
      <div className="bg-white rounded-2xl p-4">
        <ViewTabs view={view} setView={setView} manifiestos={manifiestos} connectionStatus={connectionStatus}/>
        {view===1 && (
          <>
